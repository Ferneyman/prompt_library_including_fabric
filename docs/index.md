...
Last updated: Thu Jun 19 19:32:38 AEST 2025

## Fabric Patterns

These prompts link directly to the [danielmiessler/fabric](https://github.com/danielmiessler/fabric) GitHub repository.

### [fabric: ](https://github.com/danielmiessler/fabric/blob/main/patterns//system.md)
...
### [fabric: extract wisdom short](https://github.com/danielmiessler/fabric/blob/main/patterns/extract_wisdom_short/system.md)

*Description:* IDENTITY and PURPOSE You extract surprising, insightful, and interesting information from text content. You are interested in insights related to the purpose and meaning of life, human flourishing, the role of technology in the future of humanity, artificial intelligence and its affect on humans, me...

---

### [fabric: analyze bill](https://github.com/danielmiessler/fabric/blob/main/patterns/analyze_bill/system.md)

*Description:* IDENTITY You are an AI with a 3,129 IQ that specializes in discerning the true nature and goals of a piece of legislation. It captures all the overt things, but also the covert ones as well, and points out gotchas as part of it's summary of the bill. STEPS 1. Read the entire bill 37 times using diff...

---

### [fabric: analyze bill short](https://github.com/danielmiessler/fabric/blob/main/patterns/analyze_bill_short/system.md)

*Description:* IDENTITY You are an AI with a 3,129 IQ that specializes in discerning the true nature and goals of a piece of legislation. It captures all the overt things, but also the covert ones as well, and points out gotchas as part of it's summary of the bill. STEPS 1. Read the entire bill 37 times using diff...

---

### [fabric: create coding feature](https://github.com/danielmiessler/fabric/blob/main/patterns/create_coding_feature/system.md)
...
### [AWS AI ML solutions architect](./my_prompts_consolidated/myprompt_AWS_AI_ML_solutions_architect_.md)
...
### [Code Writer](./my_prompts_consolidated/myprompt_Code_Writer_.md)
...
### [Detailed Training Guide From Documentation](./my_prompts_consolidated/myprompt_Detailed-Training-Guide-From-Documentation_.md)
...
### [Enhanced Detailed Training Guide System Prompt](./my_prompts_consolidated/myprompt_Enhanced_Detailed_Training_Guide_System_Prompt_.md)
...
### [Grammar Genie ](./my_prompts_consolidated/myprompt_Grammar-Genie__.md)
...
### [JIRA DevOps Integration](./my_prompts_consolidated/myprompt_JIRA_DevOps_Integration_.md)
...
### [Lecture Notes](./my_prompts_consolidated/myprompt_Lecture_Notes_.md)
...
### [Markdown Documenting concepts processes discussed](./my_prompts_consolidated/myprompt_Markdown-Documenting-concepts-processes-discussed_.md)
...
### [Meeting Summary](./my_prompts_consolidated/myprompt_Meeting-Summary_.md)
...
### [Multi Agent](./my_prompts_consolidated/myprompt_Multi_Agent_.md)
...
### [PRD Creation Assistant with followup questions](./my_prompts_consolidated/myprompt_PRD_Creation_Assistant_with_followup_questions_.md)
...
### [Power BI Implementation Guide Assistant](./my_prompts_consolidated/myprompt_Power_BI_Implementation_Guide_Assistant_.md)
...
### [Power BI Reporting Requirements Assistant](./my_prompts_consolidated/myprompt_Power_BI_Reporting_Requirements_Assistant_.md)
...
### [Prompt Expert](./my_prompts_consolidated/myprompt_Prompt_Expert_.md)
...
### [Proofread](./my_prompts_consolidated/myprompt_Proofread_.md)

*Description:* Please make it flow better without changing the tone in any way. I want to keep it authentically me....

---

### [RP Hypertrophy](./my_prompts_consolidated/myprompt_RP_Hypertrophy_.md)
...
### [Weekly Meal Planner](./my_prompts_consolidated/myprompt_Weekly_Meal_Planner_.md)
...
### [prd system prompt](./my_prompts_consolidated/myprompt_prd_system_prompt_.md)
...
### [requirements from code](./my_prompts_consolidated/myprompt_requirements_from_code_.md)
...
### [user personas from interviews workshops](./my_prompts_consolidated/myprompt_user_personas_from_interviews_workshops_.md)
